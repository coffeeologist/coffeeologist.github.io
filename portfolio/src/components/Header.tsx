...
export const linkedinSVG = (size = 55) => {
  return (
    ...
    >
      ...
      <g className="animated-icon-group" fill="none" fill-rule="evenodd">
        <circle
          className="animated-icon-group--outline"
          stroke-width="40"
        ...
        />
        <circle
          className="animated-icon-group--inner-circle"
          cx="300"
          cy="300"
          r="207"
        />
        <path
          className="animated-icon-group--icon"
